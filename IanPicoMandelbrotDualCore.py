...
# To use PicoGraphics for SPI 240 x 240 Pico Explorer display
...
# display.set_backlight(1.0) #no backlight conbtrol on Explorer
...
def DrawMandelbrotY():
    ...
    for y in range(0, HEIGHT, 2):
        ...
        for x in range(WIDTH): # We're drawing two rows at a time. One by the thread, the other by main.
            ...
            # convert color to r, g, b to use it. Then display.Set_pen(r, g, b). Meanwhile, it's white
            if color > 0:
                display.pixel(x,y1) # I guess sets that pixel in current pen color?
...
def DrawMandelbrotX():
    ...
    for x in range(0, WIDTH,2): # We're drawing two columns at a time. One by the thread, the other by main.
        ...
        for y in range(0, HEIGHT, 1):
            ...
            # convert color to r, g, b to use it. Then display.Set_pen(r, g, b). Meanwhile, it's white
            if color > 0:
                display.pixel(x1,y) # I guess sets that pixel in current pen color?
        #print("Main End x1=",x1)
